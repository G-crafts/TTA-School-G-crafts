...
public class ShowBunny1 extends Bunny {
    ...
    static ArrayList bunnylist=new ArrayList ();
{
    ...
    public static void main (String[] args) {
        //First attribute
        Object bunny5 = new Showbunny1.attribute (short, "Flemmishgiant", 2);
        bunnylist.add(bunny5);

        //2nd bunny's attribute
        bunny5 = new Showbunny1.attribute (long, "Highlandlop", 9);
        bunnylist.add(bunny5);

        //3rd bunny's attribute
        bunny5 = new Showbunny1.attribute (very long, "Lionhead", 16);
        bunnylist.add(bunny5);
